...
<?php if($config->login || $config->guest){ ?><li><a href="<?php echo $vz->user->setting;?>"><i class="fa <?php echo isset($_SESSION["user"]) || $config->guest ? 'fa-user'  : 'fa-sign-in';?>"></i><?php echo isset($_SESSION["user"]) || $config->guest ? "Welcome, ".$vz->user->FullName  : "Login / Register";?></a></li><?php }?>
